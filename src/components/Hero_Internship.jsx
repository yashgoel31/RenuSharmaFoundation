...
//       {/* Badge */}
//       <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-md px-4 py-2 rounded-xl border border-white/30 text-[#0a2c54] text-sm font-medium shadow-sm mb-6">
//         <FaCloudUploadAlt className="text-[#0a2c54]" />
//         No.#1 Internship Platform for Show casing you Skill on real projects
//       </div>

//       {/* Headings */}
//       <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#0a2c54] mb-4">
